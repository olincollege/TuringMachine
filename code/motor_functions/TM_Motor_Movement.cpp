...
TM_Motor_Movement::TM_Motor_Movement(
  ...
  void TM_Motor_Movement::begin() {
    ...
    eraserActuation = AFMS.getMotor(solenoidM_pin);
  ...
  // void TM_Motor_Movement::drawForwardHorizontalLine() {

  // }
  // void TM_Motor_Movement::drawBackwardHorizontalLine() {
